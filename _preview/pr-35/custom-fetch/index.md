...
The numbers come from [`bench/sentry-cli-bench.mjs`](https://github.com/BYK/binpatch/blob/main/bench/sentry-cli-bench.mjs)
— it downloads real `getsentry/cli` releases, applies the published
TRDIFF10 patch through `applyPatchChainInMemory`, and SHA-256-verifies the
reconstructed binary. Re-run it any time.
